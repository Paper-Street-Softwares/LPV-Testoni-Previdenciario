...
export default function FeatureCardLP({ icon, title, description, className }) {
  return (
    <>
      <MotionDivDownToUp
        className={`bg-transparent rounded-xl w-full flex tablet2:w-[60%] desktop1:w-[40%] desktop2:w-[45%] flex-col items-center desktop1:hover:scale-110 px-[18px] py-[18px] ${className}`}
      >
